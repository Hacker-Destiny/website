<?php /* Template: Sidebar Search Filter */ 
?>
...
<div class="um <?php echo esc_attr( $this->get_class( $mode ) ); ?> um-<?php echo esc_attr( substr( md5( $form_id ), 10, 5 ) ); ?>"
	...
	<?php $value = get_theme_mod( 'search_box_left_checkbox_setting', false ); ?>

<div class="<?php echo ( $value ) ? 'search-grid-container-for-left-search-box' : 'search-grid-container' ?>" >
