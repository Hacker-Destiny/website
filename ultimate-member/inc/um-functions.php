<?php 
	 ...
	 function prefix_add_footer_styles() {
	   wp_enqueue_style( 'um-julia', get_template_directory_uri() . '/ultimate-member/assets/css/um-kaya-julia.css',false,'1.1','all');
		wp_enqueue_script( 'julia-um-js', get_theme_file_uri( '/ultimate-member/assets/js/kaya-um-custom.js' ), array('jquery'), '', true );
	};
