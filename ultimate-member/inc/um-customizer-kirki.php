...
Kirki::add_field( 'kirki_theme_config', [
  'type'        => 'color',
  'settings'    => 'member_profile_um-field-label',
  'label'       => __( 'Profile Meta Fields Label Color', 'kirki' ), 
  'section'     => 'member_profile_page_section',
  'default'     => '#303030',
  'transport'   => 'auto',
  'output'      => array(
        array(
          'element'  => '.um-profile.um-viewing .um-field-label, .um-field-label, .um-account-main div.um-account-heading,
                         .um-name a
...
Kirki::add_field( 'kirki_theme_config', [
  'type'        => 'color',
  'settings'    => 'member_profile_um-field-value',
  'label'       => __( 'Profile Meta Fields Color', 'kirki' ), 
  'section'     => 'member_profile_page_section',
  'default'     => '#606060',
  'transport'   => 'auto',
  'output'      => array(
        array(
          'element'  => '.um-profile.um-viewing .um-field .um-field-value,
                          .um-profile-body, .um-meta-text, .um-meta, .um
          ',
           'property' => 'color',
             'suffix' => ' !important',
        ),
...
Kirki::add_field( 'kirki_theme_config', [
  'type'        => 'color',
  'settings'    => 'member_profile_um-profile-meta-link-color',
  'label'       => __( 'Profile Meta Fields Link Color', 'kirki' ), 
  'section'     => 'member_profile_page_section',
  'default'     => '#303030',
  'transport'   => 'auto',
  'output'      => array(
        array(
          'element'  => '.um-profile-meta a, .um-field-value a',
           'property' => 'color',
             'suffix' => ' !important',
        ),
    )
...
Kirki::add_field( 'kirki_theme_config', [
  'type'        => 'color',
  'settings'    => 'member_profile_um-profile-meta-link_hover-color',
  'label'       => __( 'Profile Meta Fields Link Hover Color', 'kirki' ), 
  'section'     => 'member_profile_page_section',
  'default'     => '#303030',
  'transport'   => 'auto',
  'output'      => array(
        array(
          'element'  => '.um-profile-meta a:hover, .um-field-value a:hover',
           'property' => 'color',
             'suffix' => ' !important',
        ),
    )
...
Kirki::add_field( 'kirki_theme_config', [
  ...
  'output'      => array(
        array(
          ...
          .overlay_toggle_search_icon, .toggle_search_wrapper .um-member-directory-header .searchbox_toggle_close
          ',
           'property' => 'color',
           'suffix' => ' !important',
        ),
